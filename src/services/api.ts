...
export const authAPI = {
    /**
     * Đăng nhập - hỗ trợ cả email/phoneNumber và password
     */
    login: async (credentials: { phoneNumber?: string; email?: string; password: string }) => {
...
export const citizenAPI = {
    /**
     * Gửi yêu cầu cứu hộ/cứu trợ với URL ảnh từ Frontend
     * Endpoint: POST /api/requests/addRequest
     */
    createRescueRequest: async (data: {
        type?: string;
        latitude: number;
        longitude: number;
        description: string;
        ...
        return fetchAPI('/requests/addRequest', {
            method: 'POST',
            body: JSON.stringify(data),
        });
    },
    ...
    /**
     * Gửi yêu cầu cứu trợ khẩn cấp (legacy method)
     */
    ...
    getMyRequests: async (params?: {
        ...
        return fetchAPI('/requests/my' + queryString, {
            headers: getAuthHeaders(),
        });
    },
