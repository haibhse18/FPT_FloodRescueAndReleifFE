  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 leading-tight">Danh sách vật tư</h1>
          <p className="text-sm text-gray-500 mt-1">Có {suppliesTotal} vật tư trong hệ thống</p>
        </div>
      </div>
