...
import { User, UserRole, RegisterData, LoginCredentials } from "@/modules/auth/domain/user.entity";
...
export const useAuthStore = create<AuthState>()(
    (set, get) => ({
        ...
        isAuthenticated: false,
             ...
             */
            register: async (data: RegisterData, confirmPassword: string): Promise<boolean> => {
                try {
                    set({ loading: true });
